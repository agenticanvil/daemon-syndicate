...
const CAMERA_DEPTH_DISTANCE = Math.hypot(Math.hypot(12, 12), 26);
const CAMERA_DEPTH_PITCH = THREE.MathUtils.degToRad(54.2);
const CAMERA_DEPTH_YAW = THREE.MathUtils.degToRad(28.7);
const CAMERA_DEPTH_HORIZONTAL_DISTANCE = Math.cos(CAMERA_DEPTH_PITCH) * CAMERA_DEPTH_DISTANCE;
const CAMERA_DEPTH_HEIGHT = Math.sin(CAMERA_DEPTH_PITCH) * CAMERA_DEPTH_DISTANCE;
