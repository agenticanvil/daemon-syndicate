...
export class Game {
  ...
  async prepare(): Promise<void> {
    ...
    this.world.updateGameplayLighting(this.simulation.playerPosition, this.world.camera, 0);
  ...
  private runFrame(dt: number): void {
    ...
    this.world.updatePlayerLocalAmbient(this.simulation.playerPosition);
    this.world.updateGameplayLighting(this.simulation.playerPosition, this.world.camera, dt);
